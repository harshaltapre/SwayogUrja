...
import { ArrowRight, CheckCircle2, Zap, Shield, Leaf, Sun, Users } from "lucide-react";
    ...
    <div className="flex flex-col min-h-screen">
        ...
        <div className="container-custom relative z-10 pt-10">
          ...
          >
            ...
            <p className="text-xl text-gray-200 mb-8 leading-relaxed max-w-lg">
              Switch to solar with Swayog Urja. Reduce your electricity bills by up to 90% and contribute to a greener planet.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              <FreeQuoteModal>
                <Button size="lg" className="h-14 px-8 text-lg rounded-full bg-primary text-primary-foreground hover:bg-primary/90 font-bold shadow-xl shadow-primary/20">
                  Get Free Quote
                </Button>
              </FreeQuoteModal>
              <Link href="/projects">
                <Button size="lg" variant="outline" className="h-14 px-8 text-lg rounded-full border-2 border-white text-white hover:bg-white/10 backdrop-blur-sm">
                  View Our Projects
                </Button>
              </Link>
            </div>
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <span className="text-secondary font-semibold uppercase tracking-wider text-sm">Our Solutions</span>
            <h2 className="text-3xl lg:text-4xl font-display font-bold mt-2 mb-4 text-gray-900">
              Solar Power for Every Need
            </h2>
            <p className="text-gray-600">
              Whether it's for your home, business, or industry, we provide customized solar solutions designed for maximum efficiency.
            </p>
          </div>
            ...
            {[
              ...
              >
                ...
                <div className="p-8">
                  ...
                  <Link href="/services" className="inline-flex items-center text-secondary font-semibold group-hover:translate-x-1 transition-transform">
      ...
      <section className="section-padding bg-secondary/5">
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <span className="text-primary font-semibold uppercase tracking-wider text-sm">Why Swayog Urja?</span>
              ...
              <p className="text-gray-600 mb-8 text-lg">
                We don't just install solar panels; we engineer energy independence. With over 10 years of experience, we guarantee performance and reliability.
              </p>

              <div className="space-y-6">
                {[
                  { title: "Expert Installation Team", desc: "Certified engineers ensure flawless installation." },
                  { title: "Premium Quality Components", desc: "Tier-1 panels and inverters with long-term warranties." },
                  { title: "Lifetime Support", desc: "Dedicated maintenance team for peak performance." }
                ].map((item, i) => (
              ...
              <div className="absolute -bottom-10 -left-10 w-64 p-6 bg-white rounded-2xl shadow-xl z-20 border border-gray-100 hidden md:block">
                <div className="flex items-center gap-4 mb-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-500 font-medium uppercase">Happy Clients</div>
                  </div>
                </div>
                <p className="text-sm text-gray-600">Across residential, commercial & industrial sectors.</p>
              </div>
      ...
      <section className="py-20 bg-secondary text-white relative overflow-hidden">
        ...
        <div className="container-custom relative z-10 text-center">
          <h2 className="text-3xl lg:text-5xl font-display font-bold mb-6">Ready to Switch to Solar?</h2>
          <p className="text-xl text-white/90 max-w-2xl mx-auto mb-10">
            Get a customized solar proposal for your property. It's free, and there's no obligation.
          </p>
          <FreeQuoteModal>
            <Button size="lg" className="h-16 px-10 text-xl rounded-full bg-primary text-primary-foreground hover:bg-primary/90 font-bold shadow-lg shadow-black/20">
