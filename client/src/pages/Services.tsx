...
export default function Services() {
  const services = [
    ...
    },
    {
      ...
      description:
        "Keep your solar plant running at peak efficiency. We offer comprehensive cleaning, monitoring, and repair services for existing solar installations.",
      features: [
