    ...
    <div className="flex flex-col min-h-screen pt-20">
      <section className="bg-gradient-to-br from-gray-900 to-gray-800 text-white py-20">
        <div className="container-custom text-center">
          <h1 className="text-4xl lg:text-6xl font-display font-bold mb-6">How It Works</h1>
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Our seamless 6-step process takes you from consultation to generation without any hassle.
          </p>
        </div>
      </section>
      ...
      <section className="section-padding">
        <div className="container-custom">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {steps.map((step, i) => (
              <div key={i} className="relative p-8 rounded-2xl border border-gray-200 bg-white hover:border-primary/50 hover:shadow-xl transition-all duration-300 group">
          ...
          <div className="mt-20 bg-primary/10 rounded-3xl p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8 border border-primary/20">
            <div>
              <h3 className="text-2xl font-bold mb-2 text-gray-900">Ready to start step 1?</h3>
              <p className="text-gray-600">Get your free consultation and quote today.</p>
            </div>
            <FreeQuoteModal>
              <Button size="lg" className="rounded-full px-8 bg-primary text-primary-foreground hover:bg-primary/90 font-bold shadow-lg">
                Start Now
              </Button>
            </FreeQuoteModal>
          </div>
