    ...
    <div className="flex flex-col min-h-screen pt-20">
      <section className="bg-gray-900 text-white py-20">
        <div className="container-custom text-center">
          <h1 className="text-4xl lg:text-6xl font-display font-bold mb-6">Contact Us</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      123 Solar Street, Green Tech Park,<br />
                      Innovation City, Maharashtra 400001
                    </p>
                  </div>
                </div>
              ...
              <div className="mt-12 p-6 bg-gray-50 rounded-2xl border border-gray-100">
                <h3 className="text-xl font-bold mb-2">Looking for a quick quote?</h3>
                <p className="text-gray-600 mb-4">Get an instant estimate for your rooftop solar system.</p>
                <FreeQuoteModal>
            ...
            <div className="bg-white p-8 rounded-3xl shadow-lg border border-gray-100">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button type="submit" disabled={isSubmitting} className="w-full h-12 text-lg bg-gray-900 hover:bg-gray-800">
