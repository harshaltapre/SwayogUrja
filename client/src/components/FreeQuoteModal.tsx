    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[500px] p-0 overflow-hidden border-0 shadow-2xl rounded-2xl">
        <div className="bg-gradient-to-r from-secondary to-secondary/90 p-6 text-white">
          <DialogTitle className="text-2xl font-display font-bold">Get Your Free Quote</DialogTitle>
          <DialogDescription className="text-white/80 mt-2">
            Fill out the form below and our solar experts will get back to you with a custom proposal within 24 hours.
          </DialogDescription>
        </div>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input id="name" {...form.register("name")} placeholder="Harshal Tapre" className="rounded-lg" />
              ...
              <div className="space-y-2">
                ...
                <Input id="phone" {...form.register("phone")} placeholder="9876543210" className="rounded-lg" />
            ...
            <div className="space-y-2">
              ...
              <Input id="email" type="email" {...form.register("email")} placeholder="john@example.com" className="rounded-lg" />
            ...
            <div className="space-y-2">
              ...
              <Select onValueChange={(val) => form.setValue("projectType", val as any)} defaultValue="Residential">
