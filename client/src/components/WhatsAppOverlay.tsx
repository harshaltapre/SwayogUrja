...
export function WhatsAppOverlay() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 left-6 z-[100] bg-[#25D366] text-white p-3 sm:p-4 rounded-full shadow-2xl hover:scale-110 transition-transform duration-300 flex items-center justify-center group"
